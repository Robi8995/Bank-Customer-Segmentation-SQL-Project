...
Load `Banking_Customer_Segmentation_Sample.csv` into the Banking_Customers table

### Step 4: Run Analysis Queries
Execute the SQL queries from the project file to generate insights:
- Segment customers
- Analyze by region
- Calculate engagement metrics
- Generate cross-sell reports

### Step 5: Export Results
Export query results to CSV format for BI visualization tools (Tableau, Power BI, Looker)
